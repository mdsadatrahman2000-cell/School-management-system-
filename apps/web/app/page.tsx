      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Enterprise-grade solution for managing multiple schools. 
            Streamline admissions, attendance, academics, and more.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600 text-sm">Classes, subjects, exams, and report cards</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600 text-sm">Students, teachers, guardians, and staff</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600 text-sm">Comprehensive insights and custom reports</p>
          </div>
        </div>
        ...
        <div className="mt-16 text-center text-sm text-gray-500">
          <p>Trusted by schools worldwide • Secure • Reliable • Scalable</p>
        </div>
      </div>
    </main>
  )
